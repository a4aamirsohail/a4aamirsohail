...
### 📊 [Insurance Data Analysis](https://github.com/a4aamirsohail/Insurance-Data-Analysis)
Explored key metrics and trends in insurance data to uncover business insights using SQL and Power BI.
...
- **Languages**: SQL (MS SQL Server), Python (Pandas, NumPy, Matplotlib, Seaborn)
- **Visualization**: Power BI, Tableau
- **Data Handling**: Excel (Pivot Tables, Power Query)
- **Soft Skills**: Communication, Problem Solving, Business Insight
